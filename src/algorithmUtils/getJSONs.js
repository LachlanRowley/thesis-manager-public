...
function ForMarker() {
    return __awaiter(this, void 0, void 0, function () {
        var project, academic, allInfo;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma_1.default.project.findMany({
                        include: {
                            disciplines: true,
                        }
                    })];
                case 1:
                    project = _a.sent();
                    return [4 /*yield*/, prisma_1.default.academic.findMany({})];
                case 2:
                    academic = _a.sent();
                    allInfo = [project, academic];
                    return [2 /*return*/, allInfo];
            }
        });
    });
}
var markerJson = ForMarker().then(function (result) {
    console.log(result);
