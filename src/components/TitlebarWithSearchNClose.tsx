...
export default function TitlebarWithSearchNClose({
  handleSearchButton,
  searchFilter,
  setSearchFilter,
  disciplineFilter,
    ...
    <ThemeProvider theme={theme}>
      <Box sx={{ backgroundColor: "primary.main", color: "#FFFFFF" }}>
        <div id={styles.Ribbon_container}>
          ...
          <div id={styles.Ribbon_searchbar_container}>
            ...
            <FormControl>
              ...
              >
                ...
                <MenuItem key={"Electrical"} value={"Electrical"}>
                  Electrical
                </MenuItem>
                <MenuItem key={"Mechanical"} value={"Mechanical"}>
                  Mechanical
                </MenuItem>
                <MenuItem key={"Civil"} value={"Civil"}>
                  Civil
                </MenuItem>
                <MenuItem key={"Electronic"} value={"Electronic"}>
                  Electronic
                </MenuItem>
                <MenuItem key={"Mechatronic"} value={"Mechatronic"}>
                  Mechatronic
                </MenuItem>
              </Select>
            </FormControl>
          ...
          {/* //Control Button to Close the Modal */}
          <IconButton
            aria-label="Close"
            color="inherit"
            onClick={handleClose}
